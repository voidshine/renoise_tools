...
// import Observable = renoise.Document.Observable
import * as doc from './renoise_document';

declare global {
namespace renoise.Midi {
    import renoise = doc.renoise;
...
//   -> [list of strings]
function available_input_devices(): string[];

// renoise.Midi.available_output_devices()
//   -> [list of strings]
function available_output_devices(): string[];
...
function devices_changed_observable(): renoise.Document.Observable;
...
function create_input_device(device_name: string, callback?: (message: MidiMessage) => void, sysex_callback?: (message: MidiMessage) => void): MidiInputDevice;
...
function create_output_device(device_name: string): MidiOutputDevice;
...
export interface MidiOutputDevice extends MidiDevice {
// --------------------------------------------------------------------------------
...
send(message_table: MidiMessage): void;
