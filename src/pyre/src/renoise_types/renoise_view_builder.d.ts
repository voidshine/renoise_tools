...
add_child(child_view: View): void;

// view:remove_child(View child_view)
remove_child(child_view: View): void;
...
namespace ViewBuilder {
    const DEFAULT_CONTROL_MARGIN: any;
    const DEFAULT_CONTROL_SPACING: any;
    const DEFAULT_CONTROL_HEIGHT: any;
    const DEFAULT_MINI_CONTROL_HEIGHT: any;
    const DEFAULT_DIALOG_MARGIN: any;
    const DEFAULT_DIALOG_SPACING: any;
    const DEFAULT_DIALOG_BUTTON_HEIGHT: any;
}
// prototypeless constructor
...
//   -> [Rack object]
column(children_and_properties: any): Rack;

// vb:row { Rack Properties and/or child views }
//   -> [Rack object]
row(children_and_properties: any): Rack;
