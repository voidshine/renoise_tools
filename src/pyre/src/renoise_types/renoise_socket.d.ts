...
/** @tupleReturn */
function create_client(server_address: string, server_port: number, protocol?: PROTOCOL, timeout?: number): [SocketClient | null, string | null];
...
export interface SocketClient extends SocketBase {
// --------------------------------------------------------------------------------
...
/** @tupleReturn */
send(message: renoise.Osc.Message): [boolean, string | null];
