...
// import { Observable } from './renoise_document';
import './index';
...
export namespace renoise {
    ...
    // WTF, really?! TypeScript, you ~**$!.
    import renoise = doc.renoise;
    // import Document = doc.renoise.Document;
...
export interface ScriptingTool {
    // --------------------------------------------------------------------------------
     ...
     * Returns true if the given entry already exists, otherwise false.
     */
    has_menu_entry(menu_entry_name: string): boolean

    /**
     * Add a new menu entry as described above.
     */
    add_menu_entry(menu_entry_definition_table: MenuEntryDefinition): void

    /**
     * Remove a previously added menu entry by specifying its full name.
     */
    remove_menu_entry(menu_entry_name: string): void
} // ScriptingTool
