...
//     const my_document = renoise.Document.create("MyDoc"){ }
...
//     const node = renoise.Document.create("MySubDoc"){ }
...
//     -- access properties
//     const value1 = my_document.value1
...
//     const age_observable = my_document.age
...
//     const entry = my_document.age_list[1]
...
from_string(str: string): void;
}

// TODO: "function or (object, function) or (function, object)"
export type Notifier = () => void;
export type ObjectNotifier = (this: any) => void;

export interface Observable extends Serializable {
    // --------------------------------------------------------------------------------
    ...
    //   -> [boolean]
    has_notifier(notifier: Notifier): boolean;
    has_notifier(notifier: ObjectNotifier, obj: object): boolean;
    has_notifier(obj: object, notifier: ObjectNotifier): boolean;
    ...
    add_notifier(notifier: ObjectNotifier, obj: object): void;
    add_notifier(obj: object, notifier: ObjectNotifier): void;
    ...
    remove_notifier(notifier: Notifier): void;
    remove_notifier(notifier: ObjectNotifier, obj: object): void;
    remove_notifier(obj: object, notifier: ObjectNotifier): void;
    remove_notifier(obj: object): void;
}
